...
fast-contract-checksums-verify:
	bash scripts/ci/verify_fast_contract_checksums.sh "$${FAST_CONTRACT_CHECKSUMS:-artifacts/contracts/sha256sums.txt}"
...
test-ci-fast-contract-gate-local:
	...
	$(MAKE) fast-contract-checksums-verify FAST_CONTRACT_CHECKSUMS=artifacts/contracts/sha256sums.txt; \
