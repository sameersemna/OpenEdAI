.PHONY: tidy build run migrate setup install-service test-integration test-integration-strict test-startup-config test-health-contract test-management-route-contract test-proxy-flow-contract test-proxy-usage-params-contract contract-env-status contract-env-status-json contract-env-validate-json contract-env-validate-selftest contract-env-selftest fast-contract-consistency-validate fast-contract-consistency-validate-json fast-contract-consistency-validate-selftest fast-contract-consistency-json-validate-selftest fast-contract-consistency-kpi-json fast-contract-consistency-kpi-validate-json fast-contract-consistency-kpi-validate-selftest fast-contract-consistency-kpi-assert fast-contract-consistency-kpi-assert-selftest fast-contract-consistency-reason-codes-selftest fast-contract-artifact-manifest-generate fast-contract-artifact-manifest-validate fast-contract-artifact-manifest-validate-selftest fast-contract-artifact-manifest-assert-paths fast-contract-artifact-manifest-assert-paths-selftest fast-contract-artifact-manifest-version-lock-selftest fast-contract-signed-count-version-map-parser-selftest fast-contract-signed-count-lock-matrix-selftest fast-contract-signed-count-lock-error-messages-selftest fast-contract-gate-verdict-reason-codes-selftest fast-contract-policy-fingerprint-json fast-contract-policy-fingerprint-validate-json fast-contract-policy-fingerprint-validate-selftest fast-contract-policy-fingerprint-canonical-selftest fast-contract-policy-fingerprint-drift-selftest fast-contract-checksums-generate fast-contract-checksums-verify fast-contract-checksums-verify-selftest fast-contract-checksums-tamper-selftest fast-contract-gate-manifest-assert fast-contract-gate-manifest-assert-selftest fast-contract-report-validate-markdown fast-contract-report-validate-selftest fast-contract-status-summary fast-contract-status-validate-json fast-contract-status-validate-selftest fast-contract-trend-json fast-contract-trend-validate-json fast-contract-trend-validate-selftest fast-contract-trend-assert fast-contract-gate-verdict fast-contract-gate-verdict-validate-json fast-contract-gate-verdict-validate-selftest fast-contract-gate-verdict-selftest fast-contract-artifacts-verify fast-contract-artifacts-verify-selftest test-ci-fast-contracts-preflight test-ci-fast-contracts test-ci-fast-contracts-strict test-ci-fast-contracts-strict-local test-ci-fast-contracts-report test-ci-fast-contract-gate-local test-ci-fast-proxy-usage test-prepush-local test-prepush-parity-local test-proxy-operational test-proxy-quick-local test-proxy-gate-local test-proxy-operational-flake test-race test-phase2-unit test-phase2-contract test-phase2-race test-phase2-runtime test-phase2 bench-health bench-api-errors bench-middleware bench-assert bench-assert-stable bench-assert-json bench-compare-json bench-compare-self test-ci-fast test-ci-strict test-ci-all governance-ci-fast ci-check-matrix ci-local-status smoke-gateway-local smoke-gateway-auth report-generate-local-smoke report-generate-local-smoke-auth report-latest-summary report-latest-summary-json report-compare-latest report-compare-latest-json report-trend-last report-trend-last-json report-trend-assert report-guard report-guard-auth report-guard-all report-guard-all-json report-guard-all-assert report-health-dashboard-json report-health-dashboard-json-lean report-policy-overview-json report-policy-selftest report-prune report-prune-assert report-prune-assert-json verify-workflow-conventions verify-workflow-conventions-fast-contract-expected-count-selftest verify-workflow-conventions-fast-contract-policy-fingerprint-summary-selftest verify-workflow-conventions-fast-contract-policy-fingerprint-summary-order-selftest verify-workflow-conventions-fast-contract-heartbeat-canonical-selftest verify-workflow-conventions-fast-contract-heartbeat-unexpected-vs-run-order-priority-selftest verify-workflow-conventions-fast-contract-summary-error-messages-selftest verify-workflow-conventions-fast-contract-summary-single-fault-selftest verify-workflow-conventions-fast-contract-heartbeat-duplicate-required-command-selftest verify-workflow-conventions-fast-contract-heartbeat-required-command-priority-selftest verify-workflow-conventions-fast-contract-heartbeat-required-command-order-selftest verify-workflow-conventions-fast-contract-heartbeat-mixed-fault-priority-selftest verify-workflow-conventions-fast-contract-heartbeat-unexpected-command-selftest verify-workflow-conventions-fast-contract-heartbeat-unexpected-over-missing-priority-selftest verify-workflow-conventions-fast-contract-heartbeat-step-name-lock-selftest verify-workflow-conventions-fast-contract-heartbeat-step-name-duplicate-selftest verify-workflow-conventions-fast-contract-heartbeat-required-step-name-order-selftest verify-workflow-conventions-fast-contract-heartbeat-step-name-order-vs-run-order-priority-selftest verify-workflow-conventions-fast-contract-heartbeat-step-name-vs-command-priority-selftest verify-workflow-conventions-fast-contract-heartbeat-manifest-selftest verify-workflow-conventions-fast-contract-heartbeat-manifest-version-selftest verify-workflow-conventions-fast-contract-heartbeat-manifest-keys-selftest verify-workflow-conventions-fast-contract-heartbeat-manifest-keys-vs-step-name-order-priority-selftest verify-workflow-conventions-fast-contract-heartbeat-manifest-keys-vs-command-class-order-priority-selftest verify-workflow-conventions-fast-contract-heartbeat-manifest-run-order-selftest verify-workflow-conventions-fast-contract-heartbeat-manifest-command-class-order-selftest verify-workflow-conventions-fast-contract-heartbeat-manifest-command-class-priority-selftest verify-workflow-conventions-fast-contract-heartbeat-manifest-step-name-order-selftest verify-workflow-conventions-fast-contract-heartbeat-step-count-selftest verify-workflow-conventions-fast-contract-heartbeat-make-step-name-selftest verify-workflow-conventions-fast-contract-heartbeat-verify-block-contiguous-selftest verify-governance-artifacts verify-governance-artifacts-selftest install-shellcheck-linux install-prepush-hook install-prepush-hook-dry-run install-prepush-hook-force shellcheck-scripts
...
fast-contract-artifact-manifest-assert-paths:
	bash scripts/ci/assert_fast_contract_artifact_manifest_paths.sh "$${FAST_CONTRACT_ARTIFACT_MANIFEST:-artifacts/contracts/fast-contract-artifact-manifest.json}"

fast-contract-artifact-manifest-assert-paths-selftest:
	bash scripts/ci/assert_fast_contract_artifact_manifest_paths_selftest.sh

fast-contract-artifact-manifest-version-lock-selftest:
	bash scripts/ci/validate_fast_contract_artifact_manifest_version_lock_selftest.sh

fast-contract-signed-count-version-map-parser-selftest:
	bash scripts/ci/validate_fast_contract_signed_count_version_map_parser_selftest.sh

fast-contract-signed-count-lock-matrix-selftest:
	bash scripts/ci/validate_fast_contract_signed_count_lock_matrix_selftest.sh

fast-contract-signed-count-lock-error-messages-selftest:
	bash scripts/ci/validate_fast_contract_signed_count_lock_error_messages_selftest.sh

fast-contract-gate-verdict-reason-codes-selftest:
	bash scripts/ci/validate_fast_contract_gate_verdict_reason_codes_selftest.sh

fast-contract-policy-fingerprint-json:
	bash scripts/ci/fast_contract_policy_fingerprint_json.sh "$${FAST_CONTRACT_ARTIFACT_MANIFEST:-artifacts/contracts/fast-contract-artifact-manifest.json}" "$${FAST_CONTRACT_POLICY_FINGERPRINT_JSON:-artifacts/contracts/fast-contract-policy-fingerprint.json}"

fast-contract-policy-fingerprint-validate-json:
	bash scripts/ci/validate_fast_contract_policy_fingerprint_json.sh "$${FAST_CONTRACT_POLICY_FINGERPRINT_JSON:-artifacts/contracts/fast-contract-policy-fingerprint.json}"

fast-contract-policy-fingerprint-validate-selftest:
	bash scripts/ci/validate_fast_contract_policy_fingerprint_json_selftest.sh

fast-contract-policy-fingerprint-canonical-selftest:
	bash scripts/ci/validate_fast_contract_policy_fingerprint_canonical_selftest.sh

fast-contract-policy-fingerprint-drift-selftest:
	bash scripts/ci/validate_fast_contract_policy_fingerprint_drift_selftest.sh
...
fast-contract-checksums-tamper-selftest:
	bash scripts/ci/validate_fast_contract_checksum_tamper_selftest.sh
...
fast-contract-artifacts-verify:
	bash scripts/ci/verify_fast_contract_artifacts.sh "$${FAST_CONTRACT_REPORT:?set FAST_CONTRACT_REPORT}" "$${CONTRACT_ENV_JSON:-artifacts/contracts/contract-env-status.json}" "$${FAST_CONTRACT_STATUS_SUMMARY:-artifacts/contracts/fast-contract-status-summary.json}" "$${FAST_CONTRACT_TREND_JSON:-artifacts/contracts/fast-contract-trend.json}" "$${FAST_CONTRACT_VERDICT_JSON:-artifacts/contracts/fast-contract-gate-verdict.json}" "$${FAST_CONTRACT_CONSISTENCY_JSON:-artifacts/contracts/fast-contract-consistency-status.json}" "$${FAST_CONTRACT_CONSISTENCY_KPI_JSON:-artifacts/contracts/fast-contract-consistency-kpi.json}" "$${FAST_CONTRACT_CHECKSUMS:-artifacts/contracts/sha256sums.txt}" "$${FAST_CONTRACT_ARTIFACT_MANIFEST:-artifacts/contracts/fast-contract-artifact-manifest.json}" "$${FAST_CONTRACT_POLICY_FINGERPRINT_JSON:-artifacts/contracts/fast-contract-policy-fingerprint.json}"
...
test-ci-fast-contract-gate-local:
	...
	$(MAKE) fast-contract-artifact-manifest-assert-paths FAST_CONTRACT_ARTIFACT_MANIFEST=artifacts/contracts/fast-contract-artifact-manifest.json FAST_CONTRACT_EXPECTED_SIGNED_ARTIFACT_COUNT=7 FAST_CONTRACT_SIGNED_ARTIFACT_COUNT_BY_VERSION=v1=7; \
	$(MAKE) fast-contract-policy-fingerprint-json FAST_CONTRACT_ARTIFACT_MANIFEST=artifacts/contracts/fast-contract-artifact-manifest.json FAST_CONTRACT_POLICY_FINGERPRINT_JSON=artifacts/contracts/fast-contract-policy-fingerprint.json FAST_CONTRACT_SIGNED_ARTIFACT_COUNT_BY_VERSION=v1=7; \
	$(MAKE) fast-contract-policy-fingerprint-validate-json FAST_CONTRACT_POLICY_FINGERPRINT_JSON=artifacts/contracts/fast-contract-policy-fingerprint.json; \
...
governance-ci-fast:
	...
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-unexpected-vs-run-order-priority-selftest
	...
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-required-step-name-order-selftest
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-step-name-order-vs-run-order-priority-selftest
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-step-name-vs-command-priority-selftest
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-manifest-selftest
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-manifest-version-selftest
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-manifest-keys-selftest
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-manifest-keys-vs-step-name-order-priority-selftest
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-manifest-keys-vs-command-class-order-priority-selftest
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-manifest-run-order-selftest
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-manifest-command-class-order-selftest
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-manifest-command-class-priority-selftest
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-manifest-step-name-order-selftest
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-step-count-selftest
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-make-step-name-selftest
	$(MAKE) verify-workflow-conventions-fast-contract-heartbeat-verify-block-contiguous-selftest
...
verify-workflow-conventions-fast-contract-expected-count-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_expected_count_selftest.sh

verify-workflow-conventions-fast-contract-policy-fingerprint-summary-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_policy_fingerprint_summary_selftest.sh

verify-workflow-conventions-fast-contract-policy-fingerprint-summary-order-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_policy_fingerprint_summary_order_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-canonical-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_canonical_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-unexpected-vs-run-order-priority-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_unexpected_vs_run_order_priority_selftest.sh

verify-workflow-conventions-fast-contract-summary-error-messages-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_summary_error_messages_selftest.sh

verify-workflow-conventions-fast-contract-summary-single-fault-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_summary_single_fault_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-duplicate-required-command-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_duplicate_required_command_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-required-command-priority-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_required_command_priority_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-required-command-order-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_required_command_order_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-mixed-fault-priority-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_mixed_fault_priority_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-unexpected-command-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_unexpected_command_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-unexpected-over-missing-priority-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_unexpected_over_missing_priority_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-step-name-lock-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_step_name_lock_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-step-name-duplicate-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_step_name_duplicate_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-required-step-name-order-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_required_step_name_order_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-step-name-order-vs-run-order-priority-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_step_name_order_vs_run_order_priority_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-step-name-vs-command-priority-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_step_name_vs_command_priority_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-manifest-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_manifest_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-manifest-version-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_manifest_version_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-manifest-keys-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_manifest_keys_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-manifest-keys-vs-step-name-order-priority-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_manifest_keys_vs_step_name_order_priority_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-manifest-keys-vs-command-class-order-priority-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_manifest_keys_vs_command_class_order_priority_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-manifest-run-order-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_manifest_run_order_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-manifest-command-class-order-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_manifest_command_class_order_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-manifest-command-class-priority-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_manifest_command_class_priority_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-manifest-step-name-order-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_manifest_step_name_order_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-step-count-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_step_count_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-make-step-name-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_make_step_name_selftest.sh

verify-workflow-conventions-fast-contract-heartbeat-verify-block-contiguous-selftest:
	bash scripts/ci/verify_workflow_conventions_fast_contract_heartbeat_verify_block_contiguous_selftest.sh
