...
test-ci-fast-contract-gate-local:
	...
	$(MAKE) fast-contract-artifact-manifest-assert-paths FAST_CONTRACT_ARTIFACT_MANIFEST=artifacts/contracts/fast-contract-artifact-manifest.json FAST_CONTRACT_EXPECTED_SIGNED_ARTIFACT_COUNT=7; \
